...
#       script in the CrayTest repository that verifies the basic health
#       of various microservices but instead focuses exclusively on the
#       hmcollector. It was implemented to run from the ct-pipelines
#       container off of the NCN of the system under test within the DST
#       group's Continuous Testing (CT) framework as part of the
#       remote-smoke test suite.
#
